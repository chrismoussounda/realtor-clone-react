    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto ">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form>
            <input
              className="w-full text-xl bg-white transition ease-in-out rounded border-gray-300 mb-6"
              type="text"
              id="name"
              value={name}
              onChange={onChange}
            ...
            <div className="relative mb-6">
              <input
                className="w-full text-xl bg-white transition ease-in-out rounded border-gray-300"
